...
namespace Berico.SnagL.Infrastructure.Modularity
{
    ...
    public static class ExtensionManager
    {
        ...
        public static void Initialize()
        {
            ...
            if (!initialized)
            {
                ...
                try
                {
                    ...
                    foreach (Extension extension in Configuration.ConfigurationManager.Instance.CurrentConfig.Extensions)
                    {
        ...
        {
            Expression<Func<ComposablePartDefinition, bool>> findAllActionExtensions = (def) => (def.ExportDefinitions.Any(exportDef => exportDef.ContractName.EndsWith("LayoutBase")));
            FilteredCatalog newFilteredCatalog = new FilteredCatalog(parentCatalog, findAllActionExtensions);
