...
{
    [PartMetadata("ID", "ToolbarItemViewModelExtension"), Export(typeof(ExportToolbarItemExtensionViewModel))]
    public class ExportToolbarItemExtensionViewModel : ViewModelBase, IToolbarItemViewModelExtension
    {
        ...
        /// Extensions.ExportToolbarItemExtensionViewModel
        /// </summary>
        public ExportToolbarItemExtensionViewModel()
        {
            this.index = 6;
            this.description = "Export:  Export data from the graph to various formats";
