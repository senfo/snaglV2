...
namespace Berico.SnagL.Infrastructure.Graph
{
    ...
    public class NodeViewModelBase : ViewModelBase, INodeShape
    {
        ...
        private bool isGroupNode = false;
        ...
        public void AnimateTo(Point targetPosition)
        {
            ...
            animator.FrameAnimated += new EventHandler(animator_FrameAnimated);
        ...
        private void animator_FrameAnimated(object sender, EventArgs e)
        {
