...
namespace Berico.SnagL.Infrastructure.Clustering
{
    ...
    public class AttributeSimilarityManager : IPartImportsSatisfiedNotification
    {
        ...
        List<AttributeSimilarityDescriptor> similarityDescriptors = null;
        ...
        public static AttributeSimilarityManager Instance
        {
            get
            {
                ...
                if (instance == null)
                {
                    ...
                    throw new System.InvalidOperationException("The AttributeSimilarityManager class must be initialized (using the InitialSetup method) before the Instance property can be used.");
                }
