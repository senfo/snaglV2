...
{
    [PartMetadata("ID", "ToolbarItemViewModelExtension"), Export(typeof(GraphToImageToolbarItemExtensionViewModel))]
    public class GraphToImageToolbarItemExtensionViewModel : ViewModelBase, IToolbarItemViewModelExtension
    {
        ...
        /// </summary>
        public GraphToImageToolbarItemExtensionViewModel()
        {
            this.index = 7;
            this.description = "Graph-To-Image:  Save an image (Jpeg or Png) of the graph";
            this.isChecked = false;
            this.Name = "GRAPH_TO_IMAGE";
        }
